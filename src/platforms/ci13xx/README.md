...
`examples/CI130X/CI130X.ino` drives eight WS2812B LEDs. It selects PD0 on
CI1306 boards and the common PA4 pin on CI1302/CI1303 boards.
...
## Nuclei GCC 9.2 LTO workaround

The CI13XX Arduino toolchain's GCC 9.2 linker can fail internally while
processing FastLED's unity-build objects with LTO. Disable C++ LTO for builds
...
This flag is scoped to the CI13XX build and is not required by other FastLED
targets.
